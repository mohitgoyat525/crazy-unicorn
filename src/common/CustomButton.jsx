...
const CustomButton = ({ text, myClass, buttonClass }) => {
  return (
    ...
    >
      <button
        className={`${buttonClass} font-pinkyUnicorn mt-[2px] text-[35px] max-md:text-2xl max-md:py-3 max-sm:py-2 max-sm:px-6 max-md:px-8 leading-[40.26px] bg-white py-[16.2px] px-[49px] rounded-xl text-nowrap border border-black absolute -top-[7px] -left-[5px] hover:-top-[3px] hover:left-0 transition-all duration-300`}
      >
        {' '}
